...
class DistrictsControllerTest < ActionController::TestCase
  ...
  test "should create district" do
    assert_difference('District.count') do
      post :create, district: { country_id: @district.country_id, county_id: @district.county_id, level_id: @district.level_id, name: @district.name, state_id: @district.state_id }
    end
  ...
  test "should update district" do
    patch :update, id: @district, district: { country_id: @district.country_id, county_id: @district.county_id, level_id: @district.level_id, name: @district.name, state_id: @district.state_id }
    assert_redirected_to district_path(assigns(:district))
  end
