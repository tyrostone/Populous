...
class ContributionsControllerTest < ActionController::TestCase
  ...
  test "should create contribution" do
    assert_difference('Contribution.count') do
      post :create, contribution: { issue_id: @contribution.issue_id, representative_id: @contribution.representative_id, user_id: @contribution.user_id, value: @contribution.value }
    end
  ...
  test "should update contribution" do
    patch :update, id: @contribution, contribution: { issue_id: @contribution.issue_id, representative_id: @contribution.representative_id, user_id: @contribution.user_id, value: @contribution.value }
    assert_redirected_to contribution_path(assigns(:contribution))
  end
